...
const file_notification_v1_notification_proto_rawDesc = "" +
	"\n" +
	"\"notification/v1/notification.proto\x12\x19ecommerce.notification.v1\"i\n" +
	...
	"\tSendEmail\x12+.ecommerce.notification.v1.SendEmailRequest\x1a,.ecommerce.notification.v1.SendEmailResponseBPZNgithub.com/rajeev/ecommercesagapattern/shared/pb/notificationv1;notificationv1b\x06proto3"
...
var file_notification_v1_notification_proto_goTypes = []any{
	(*SendEmailRequest)(nil),  // 0: ecommerce.notification.v1.SendEmailRequest
	(*SendEmailResponse)(nil), // 1: ecommerce.notification.v1.SendEmailResponse
}
var file_notification_v1_notification_proto_depIdxs = []int32{
	0, // 0: ecommerce.notification.v1.NotificationService.SendEmail:input_type -> ecommerce.notification.v1.SendEmailRequest
	1, // 1: ecommerce.notification.v1.NotificationService.SendEmail:output_type -> ecommerce.notification.v1.SendEmailResponse
