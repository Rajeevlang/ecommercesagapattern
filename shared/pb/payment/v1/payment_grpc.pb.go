...
const (
	PaymentService_ProcessPayment_FullMethodName = "/ecommerce.payment.v1.PaymentService/ProcessPayment"
	PaymentService_CancelPayment_FullMethodName  = "/ecommerce.payment.v1.PaymentService/CancelPayment"
)
